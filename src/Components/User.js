    ...
    return (
        <div>
            ...
            <div className="row justify-content-center my-3">
                ...
                <h2 className="col-12 text-light mt-5">Blogs</h2>
                {blogs &&
                    blogs.length > 0 ?
                    blogs.map(b => (
                        < div key={b.blog_id} className="col-5 mb-4 bg-light PostList border border-dark" >
                            <div className="container mt-1">
                                <Link className="text-decoration-none" to={`/post/${b.blog_id}`}>
                                    <h3>{b.title}</h3>
                                </Link>
                ...
                <h2 className="col-12 text-light mt-5">Posts</h2>
                {posts &&
                    posts.length > 0 ?
                    posts.map(p => (
                        < div key={p.post_id} className="col-5 mb-4 bg-light PostList border border-dark" >
                            <div className="container mt-1">
